...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($checkBudgetQuery) === 1) {
        ...
        mysqli_query($conn, "INSERT INTO History (Id_Wallet, Id_Budget, Title, Type, Amount, Description, Date) VALUES ('$Wallet', '$Budget', '$title', 'Expense', '$Amount', '$Description', '$cDate')");
